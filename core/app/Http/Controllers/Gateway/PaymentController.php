...
class PaymentController extends Controller
{
    ...
    public static function userDataUpdate($deposit, $isManual = null)
    {
        if ($deposit->status == Status::PAYMENT_INITIATE || $deposit->status == Status::PAYMENT_PENDING) {
            ...
            $percentageAmount = (($amount/100)*$currency_percentage);

            $referrer = "";
            $ref = Referral::where("user_id",$deposit->user_id)->first();
            ...
            if(!empty($referrer)){
                ...
                $transaction->details      = __('Payment By Currency Purchase by Referral');
