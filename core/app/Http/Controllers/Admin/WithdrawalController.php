...
class WithdrawalController extends Controller
{
    ...
    protected function withdrawalData($scope = null, $summery = false){
        ...
        $withdrawals = $withdrawals->searchable(['trx','user:username'])->filter(['user_id'])->dateFilter();
        $request     = request();
        if ($request->method) {
    ...
    public function reject(Request $request)
    {
        ...
        $transaction->details      = 'Zwrot z powodu odrzucenia wypłaty:' . ' ' . showAmount($withdraw->amount) . ' ' . $general->cur_text;
