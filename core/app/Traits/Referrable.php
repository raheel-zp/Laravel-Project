...
trait Referrable
{
     ...
     * @return string|null
     */
    public function getOldReferralCode()
    {
        if ($this->hasReferralAccount()) {
            return $this->referralAccount->old_referral_code;
        }
     ...
     * @return void
     */
    public function createReferralAccount(int $referrerID = NULL, $httpReferrer = NULL, $oldReferralCode = NULL)
    {
        ...
        $ref->http_referrer = $httpReferrer;
        $ref->old_referral_code = $oldReferralCode;
