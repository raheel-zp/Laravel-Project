        ...
        <table class="table custom--table">
            <thead>
                <tr>
                    ...
                    <th class="text-center">@lang('Task offers added')</th>
                    <th class="text-center">@lang('Completed Tasks')</th>
                    <th class="text-center">@lang('Position')</th>
                </tr>
            </thead>
            <tbody>
                @forelse($leaderBoard as $k => $leader)
                @if($k<5)
                    <tr>
                        <td>
                        ...
                        <td class="transacted">
                            <div class="text--end">
                                <span class="d-block">
                                    {{ $leader["completed_jobs"] }}
                                </span>
                            </div>
                        </td>

                        <td>
                            <strong><p>{{ $k+1 }}</p></strong>
                        </td>
