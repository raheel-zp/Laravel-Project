    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.filetype*') }}">
                    <a href="{{ route('admin.filetype.index') }}" class="nav-link ">
                        <i class="menu-icon las la-file"></i>
                        <span class="menu-title">@lang('File Type')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive('admin.disputes*') }}">
                    <a href="{{ route('admin.disputes.index') }}" class="nav-link ">
                        <i class="menu-icon las la-file"></i>
                        <span class="menu-title">@lang('Manage Disputes')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.jobs*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.jobs.approved') }} ">
                                <a href="{{ route('admin.jobs.approved') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Jobs')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.jobs.rejected') }} ">
                                <a href="{{ route('admin.jobs.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.users*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.banned') }} ">
                             ...
                             <li class="sidebar-menu-item {{ menuActive('admin.users.blocked') }} ">
                                <a href="{{ route('admin.users.blocked') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Blocked Users')</span>
                                    @if ($blockedUsersCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $blockedUsersCount }}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.users.executed.blocked') }} ">
                                <a href="{{ route('admin.users.executed.blocked') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Blocked users for executing jobs')</span>
                                    @if ($blockedExecutionUsersCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $blockedExecutionUsersCount }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.setting.referralSettings') }}">
                    <a href="{{ route('admin.setting.referralSettings') }}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Referral Setting')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive('admin.setting.badwordsSettings') }}">
                    <a href="{{ route('admin.setting.badwordsSettings') }}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Forbidden Words')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{ menuActive('admin.setting.contestSettings') }}">
                    <a href="{{ route('admin.setting.contestSettings') }}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Contest Settings')</span>
                    </a>
                </li>
