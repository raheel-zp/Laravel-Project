...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.withdraw.log') }}" icon="lar la-credit-card" title="Total Withdrawan" value="{{ $general->cur_sym }}{{ showAmount($withdrawals['total_withdraw_amount']) }}" color="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.jobs.index') }}" icon="lar la-flag" title="Total Jobs" value="{{ $job['total_job'] }}" bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.jobs.pending') }}" icon="fas fa-spinner" title="Pending jobs" value="{{ $job['pending_job'] }}" bg="warning" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.jobs.complete') }}" icon="las la-check-circle" title="Complete jobs" value="{{ $job['complete_job'] }}" bg="green" />

        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.jobs.rejected') }}" icon="las la-times-circle" title="Rejected jobs" value="{{ $job['cancel_job'] }}" bg="16" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->

    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.jobs.index') }}" icon_style="false" icon="fas fa-money-check-alt" title="Total Jobs Amount" value="{{ $general->cur_sym }}{{ showAmount($job['total_job_amount']) }}" color="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.jobs.pending') }}" icon_style="false" icon="las la-spinner" title="Pending Jobs Amount" value="{{ $general->cur_sym }}{{ showAmount($job['pending_job_amount']) }}" color="warning" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.jobs.complete') }}" icon_style="false" icon="las la-check-circle" title="Completed Jobs Amount" value="{{ $general->cur_sym }}{{ showAmount($job['complete_job_amount']) }}" color="green" />

        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.jobs.rejected') }}" icon_style="false" icon="las la-ban" title="Rejected Jobs Amount" value="{{ $general->cur_sym }}{{ showAmount($job['cancel_job_amount']) }}" color="red" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
