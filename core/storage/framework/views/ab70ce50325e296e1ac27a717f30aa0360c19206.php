                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 flex-wrap justify-content-end">
                                                ...
                                                <a href="<?php echo e(route('admin.jobs.edit', $job->id)); ?>" class="btn btn-sm btn-outline--success">
                                                <i class="las la-edit "></i><?php echo app('translator')->get('Edit'); ?>
                                                </a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\microlab-freelancing-platform\core\resources\views/admin/jobs/index.blade.php ENDPATH**/ ?>