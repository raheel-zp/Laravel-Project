<?php $__env->startSection('panel'); ?>
    <div class="dashboard__content">
        <div class="finished__jobs__wrapper">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $job->proves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prove): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="col-md-6 col-lg-12 col-xl-6">
                            <div class=" job__body d-flex flex-wrap justify-content-between align-items-center">
                                ...
                                <div class="job__footer">
                                    ...
                                    <p class="take-on-date"><?php echo e(showDateTime($prove->created_at, 'Y-m-d H:i:s')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/srv31316/domains/i-ty.pl/public_html/core/resources/views/templates/basic/user/job/details.blade.php ENDPATH**/ ?>