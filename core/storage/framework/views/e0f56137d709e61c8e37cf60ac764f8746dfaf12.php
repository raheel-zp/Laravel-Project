<?php $__env->startSection('panel'); ?>
    <div class="dashboard__content contact__form__wrapper">
        <form action="<?php echo e(route('user.deposit.insert')); ?>" method="post">
            ...
            <button type="submit" class="btn btn--base w-100 mt-3"><?php echo app('translator')->get('Kupuję'); ?></button>
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/srv31316/domains/zlecenio.eu/public_html/core/resources/views/templates/basic/user/payment/deposit.blade.php ENDPATH**/ ?>