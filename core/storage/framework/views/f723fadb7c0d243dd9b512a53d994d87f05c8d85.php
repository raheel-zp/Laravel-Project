    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                    ...
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.users*', 2)); ?> ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.users.banned')); ?> ">
                             ...
                             <li class="sidebar-menu-item <?php echo e(menuActive('admin.users.blocked')); ?> ">
                                <a href="<?php echo e(route('admin.users.blocked')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Blocked Users'); ?></span>
                                    <?php if($blockedUsersCount): ?>
                                        <span class="menu-badge pill bg--danger ms-auto"><?php echo e($blockedUsersCount); ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.setting.referralSettings')); ?>">
                    <a href="<?php echo e(route('admin.setting.referralSettings')); ?>" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\microlab-freelancing-platform\core\resources\views/admin/partials/sidenav.blade.php ENDPATH**/ ?>