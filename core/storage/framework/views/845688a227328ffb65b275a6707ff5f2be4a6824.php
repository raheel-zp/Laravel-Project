...
<?php endif; ?>
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <?php if($user->block_status == 0 || $user->block_status == ""): ?>
                        <button type="button" class="btn btn--warning btn--gradi btn--shadow w-100 btn-lg userBlockStatus"
                            ...
                            <i class="las la-ban"></i><?php echo app('translator')->get('Block User'); ?>
                        </button>
                    <?php else: ?>
                        <button type="button" class="btn btn--success btn--gradi btn--shadow w-100 btn-lg userBlockStatus"
                            data-bs-toggle="modal" data-bs-target="#userBlockStatusModal">
                            <i class="las la-undo"></i><?php echo app('translator')->get('Unblock User'); ?>
                        </button>
                    <?php endif; ?>
                </div>
    ...
    <div id="userBlockStatusModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <?php if($user->block_status == 0): ?>
                            <span><?php echo app('translator')->get('Block User'); ?></span>
                        <?php else: ?>
                            <span><?php echo app('translator')->get('Unblock User'); ?></span>
                        <?php endif; ?>
                    </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                ...
                <form action="<?php echo e(route('admin.users.block.status', $user->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <?php if($user->block_status == 0  || $user->block_status == ""): ?>
                            <h6 class="mb-2"><?php echo app('translator')->get('If you ulbock this user he/she won\'t able to post job his/her dashboard.'); ?></h6>
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Reason'); ?></label>
                                <textarea class="form-control" name="reason" rows="4" required></textarea>
                            </div>
                        <?php else: ?>
                            <p><span><?php echo app('translator')->get('Block reason was'); ?>:</span></p>
                            <p><?php echo e($user->block_reason); ?></p>
                            <h4 class="text-center mt-3"><?php echo app('translator')->get('Are you sure to unblock this user?'); ?></h4>
                        <?php endif; ?>
                    </div>
                    <div class="modal-footer">
                        <?php if($user->block_status == 0 || $user->block_status == ""): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\microlab-freelancing-platform\core\resources\views/admin/users/detail.blade.php ENDPATH**/ ?>