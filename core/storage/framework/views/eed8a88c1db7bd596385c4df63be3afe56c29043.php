    ...
    <div class="container">
        <div class="header-bottom-area">
            ...
            <ul class="menu">
                ...
                <li><a href="<?php echo e(route('job.list')); ?>" class="<?php echo e(request()->routeIs('job.list') ? 'active' : ''); ?>"><?php echo app('translator')->get('Jobs'); ?></a></li>
...
<?php /**PATH /home/srv31316/domains/i-ty.pl/public_html/core/resources/views/templates/basic/partials/header.blade.php ENDPATH**/ ?>