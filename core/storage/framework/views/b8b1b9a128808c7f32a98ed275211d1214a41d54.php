...
<div class="col-lg-4 col-xl-3">
    <div class="dashboard__sidebar">
        ...
        <ul class="dashboard__sidebar__menu">
            ...
            <li class="has__submenu">
                <a href="javascript:void(0)"><?php echo app('translator')->get('RefLink'); ?></a>
                <ul class="sidebar__submenu">
                    <li>
                        <a href="<?php echo e(route('user.referral.getReferralLink')); ?>" class="<?php echo e(menuActive(['user.referral.getReferralLink'])); ?>">
                            <?php echo app('translator')->get('Your RefLink'); ?>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('user.job.history')); ?>" class="<?php echo e(menuActive(['user.job.history', 'user.job.details'])); ?>">
                            <?php echo app('translator')->get('RefLink History'); ?>
                        </a>
                    </li>
                </ul>
            </li>
...
<?php /**PATH C:\xampp\htdocs\microlab-freelancing-platform\core\resources\views/templates/basic/partials/sidebar.blade.php ENDPATH**/ ?>